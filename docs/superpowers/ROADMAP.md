...
- [ ] Freeze shared contracts: data model, DB schema, RAG API, **L7 journal schema**
...
- [ ] P2 discretionary stub: emits 1 hand-stubbed reasoned ticker candidate
- [ ] P3 stub: behavioral log + echo a canned "decision-aid" answer
...
**Exit criterion:** one command runs idea → proposal → human gate → journal, across all three pipelines.

---

## Parallel Tracks (start after Phase 1; contracts frozen)

### Track A — P1 Quant Pipeline depth
...
### Track C — P3 Decision-Aid depth
- [ ] Behavioral expectancy gap (planned R − realized R, in R and HKD)
- [ ] Binding behavioral guardrails (stop required, no averaging losers, cooldown, etc.)
...
- [ ] On-demand trade-inquiry answers
- [ ] Skill-growth tracking

### Track D — P2 Core Discretionary depth (depends on Track B)
...
- 2026-06-21: Architecture = **three pipelines** (P1 quant white-box / P2 discretionary black-box core / P3 decision-aid).
